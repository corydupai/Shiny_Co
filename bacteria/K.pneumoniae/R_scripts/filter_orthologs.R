...
# Read in match table
match.table <- read.table("/stor/work/Wilke/tingle/WGCNA_expanded/K.pneumoniae/panoct_output/pangenome/results/matchtable_0_1.txt", header=FALSE)
...
# ortholog.list.df <- list2df(ortholog.list)
